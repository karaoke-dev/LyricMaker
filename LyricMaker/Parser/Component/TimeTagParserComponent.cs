...
namespace LyricMaker.Parser.Component
{
    ...
    public class TimeTagParserComponent : ParserComponent<LyricLine>
    {
        public override LyricLine Decode(string t)
        {
            ...
            for (int pi = 1; pi < pairs.Length; pi++)
            {
            ...
            for (int i = 0; i < timeTags.Length; i += 2)
            {
        ...
        public override string Encode(LyricLine line)
        {
            ...
            for (int i = 0; i < line.Text.Length; i++)
                sb.Append(TimeTagedChar(line, i));
            ...
            /// <summary>
            /// Get time tag and char by index
            /// </summary>
            /// <example>
            /// Input : 0
            /// Output : [00:17.97]帰
            /// 
            /// Input : (last)
            /// Outout : [00:18.94]は[00:19.22]
            /// </example>
            /// <param name="index"></param>
            /// <returns></returns>
            string TimeTagedChar(LyricLine l, int index)
            {
                TimeTag t1 = l.TimeTags[1 + index * 2];
                TimeTag t2 = l.TimeTags[1 + index * 2 + 1];
